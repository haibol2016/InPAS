#' Get 3' UTR regions based on CP sites
#'
#' @param CPsites CP sites detected by [CPsites()] or [integrateCPsites()]
...
#'   each seqname (chromosome/scaffold)
#' @export

get3UTRCDSRegions <- function(CPsites,
                           utr3,
                           BPPARAM = NULL){
    ...
    utr3.cds.regions.chr <- split(utr3.cds.regions, as.character(seqnames(utr3.cds.regions)))
    utr3.cds.regions.chr <- utr3.cds.regions.chr[seqnames]
