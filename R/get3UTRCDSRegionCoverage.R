...
#' Get coverage for 3' UTR regions of a given chromosome
#'
#' @param seqname chromosome/scaffold name
#' @param utr3.cds.regions.chr An object of [GenomicRanges::GRangesList-class], with 
#'   a GRanges for each seqname (chromosome/scaffold). It is the output from the
#'   [get3UTRCDSRegions()]
...
#' @param tmpfolder A path to a folder for storing coverage data of 3' UTRs on a given
#'   given chromosome/scaffold
#' @param phmm logical(1), indicatin whether data should be prepared for singleSample
#'   analysis? By default, FALSE
#'
#' @return coverage view
#' @export
#' 
get3UTRCDSRegionCoverage <- function(seqname,
                                  utr3.cds.regions.chr,
                                  hugeData = TRUE,
                                  coverage,
                                  tmpfolder = NULL,
                                  phmm = FALSE){
